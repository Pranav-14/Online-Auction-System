...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-development-secret-key-online-auction-system')
...
if DB_ENGINE and 'postgresql' in DB_ENGINE and os.environ.get('USE_SQLITE', 'False').lower() not in ('true', '1'):
    DATABASES = {
        'default': {
            'ENGINE': DB_ENGINE,
